    ...
    <div class="section-gray">
        ...
        <div class="container">
            ...
            @foreach($trackers as $tracker)
                @if($tracker->month == 'current' AND $tracker->name == 'KAPA')
                    <div class="pt-5">
                ...
                @endif
                @if($tracker->month == 'second' AND $tracker->name == 'KAPA')
                    <div class="pb-5">
                        <div class="d-flex justify-content-center my-2">
                        </div>
                        <div class="bar rounded d-flex justify-content-start">
                ...
                <div class="row row-cols-3 row-cols-sm-3 row-cols-md-6 row-cols-lg-12">
                    ...
                    <div class="col my-3"><h4>Jan</h4>
                        @foreach($trackers->where('year', '2021') as $tracker)
                            @if($tracker->month == 'Jan' AND $tracker->name == 'KAPA')
                    ...
                    <div class="col my-3"><h4>Feb</h4>
                        @foreach($trackers->where('year', '2021') as $tracker)
                            @if($tracker->month == 'Feb' AND $tracker->name == 'KAPA')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
                    ...
                    <div class="col my-3"><h4>Mar</h4>
                        @foreach($trackers->where('year', '2021') as $tracker)
                            @if($tracker->month == 'Mar' AND $tracker->name == 'KAPA')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
                    ...
                    <div class="col my-3"><h4>Apr</h4>
                        @foreach($trackers->where('year', '2021') as $tracker)
                            @if($tracker->month == 'Apr' AND $tracker->name == 'KAPA')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
                    ...
                    <div class="col my-3"><h4>May</h4>
                        @foreach($trackers->where('year', '2021') as $tracker)
                            @if($tracker->month == 'May' AND $tracker->name == 'KAPA')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
                    ...
                    <div class="col my-3"><h4>Jun</h4>
                        @foreach($trackers->where('year', '2021') as $tracker)
                            @if($tracker->month == 'Jun' AND $tracker->name == 'KAPA')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
                    ...
                    <div class="col my-3"><h4>Jul</h4>
                        @foreach($trackers->where('year', '2021') as $tracker)
                            @if($tracker->month == 'Jul' AND $tracker->name == 'KAPA')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
                    ...
                    <div class="col my-3"><h4>Aug</h4>
                        @foreach($trackers->where('year', '2021') as $tracker)
                            @if($tracker->month == 'Aug' AND $tracker->name == 'KAPA')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
                    ...
                    <div class="col my-3"><h4>Sep</h4>
                        @foreach($trackers->where('year', '2021') as $tracker)
                            @if($tracker->month == 'Sep' AND $tracker->name == 'KAPA')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
                    ...
                    <div class="col my-3"><h4>Oct</h4>
                        @foreach($trackers->where('year', '2021') as $tracker)
                            @if($tracker->month == 'Oct' AND $tracker->name == 'KAPA')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
                    ...
                    <div class="col my-3"><h4>Nov</h4>
                        @foreach($trackers->where('year', '2021') as $tracker)
                            @if($tracker->month == 'Nov' AND $tracker->name == 'KAPA')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
                    ...
                    <div class="col my-3"><h4>Dec</h4>
                        @foreach($trackers->where('year', '2021') as $tracker)
                            @if($tracker->month == 'Dec' AND $tracker->name == 'KAPA')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
