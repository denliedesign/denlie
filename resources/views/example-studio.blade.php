    ...
    <div class="section-gray">
        ...
        <div class="container">
            <div class="py-5">
                ...
                <p class="lead text-center">Example Studio</p>
            </div>
            <div class="pb-5">
            ...
            <div class="py-5">
                <div class="row row-cols-3 row-cols-sm-3 row-cols-md-6 row-cols-lg-12">
                    ...
                    <div class="col my-3"><h4>Jan</h4> 1 hr 15</div>
                    <div class="col my-3"><h4>Feb</h4> 1 hr</div>
                    <div class="col my-3"><h4>Mar</h4> 30 min</div>
                    <div class="col my-3"><h4>Apr</h4> 0</div>
                    <div class="col my-3"><h4>May</h4> 45 min</div>
                    <div class="col my-3"><h4>Jun</h4> 45 min</div>
                    <div class="col my-3"><h4>Jul</h4> 1 hr</div>
                    <div class="col my-3"><h4>Aug</h4> 0</div>
                    <div class="col my-3"><h4>Sep</h4> 0</div>
                    <div class="col my-3"><h4>Oct</h4> 2 hr</div>
                    <div class="col my-3"><h4>Nov</h4> 1 hr 15</div>
                    <div class="col my-3"><h4>Dec</h4> 15 min</div>
                </div>
            </div>
        </div>
    </div>
