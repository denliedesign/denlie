...
@section('content')
    ...
    <section id="section-colors-blue" style="height: 100vh; overflow: hidden;" onclick="blueToRed()">
        <div class="container">
            <div class="row my-5">
    ...
    <section id="section-colors-red" style="height: 100vh; overflow: hidden;" onclick="redToYellow()">
        <div class="container">
            <div class="row my-5">
                <div class="col-sm" style="position: relative;">
                ...
                <div class="col-sm d-flex align-items-center">
                    <div class="text-right animate-red-text" style="opacity: 0; color: #3c4246;">
                        <h1 class="sou-title mb-4">Ballet</h1>
                        <p class="sou-text">Ballet is an elegant and historic dance form renowned for its grace and difficulty with precise and highly formalized set steps and gestures. It originated in Renaissance Italy and established its present form during the 19th century.</p>
                    </div>
                </div>
            </div>
        </div>
    </section>
    <section id="section-colors-yellow" style="height: 100vh; overflow: hidden;" onclick="yellowToPurple()">
        <div class="container">
            <div class="row my-5">
                <div class="col-sm d-flex align-items-center">
                    <div class="animate-yellow-text" style="opacity: 0; color: #3c4246;">
                        <h1 class="sou-title mb-4">Jazz</h1>
                        <p class="sou-text">Jazz dancing is a form that showcases a dancer's originality. All jazz dancers interpret and execute moves and steps in their own way. This type of dancing consists of fancy footwork, big leaps, and quick turns.</p>
                    </div>
                </div>
                <div class="col-sm" style="position: relative;">
...
{{--                        <h1 style="font-family: 'Galano Grotesque'; font-size: 6em; line-height: 1.618em;" class="text-uppercase mb-4">Mod<br><span style="letter-spacing: 11.75px;">ern</span></h1>--}}
                        <h1 class="sou-title mb-4">Modern</h1>
                        <p class="sou-text">Modern dance is a dance style that focuses on a dancer's own interpretations instead of structured steps, as in traditional ballet dancing. Modern dancers reject limitations of classical ballet and favor movements derived from the expression of their inner feelings.</p>
                    </div>
                </div>
            </div>
        </div>
