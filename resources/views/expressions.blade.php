    ...
    <div class="section-gray">
        ...
        <div class="container">
            <div class="pt-5">
                ...
                <p class="lead text-center">Expressions Dance Theatre</p>
            </div>
            @foreach($trackers as $tracker)
                @if($tracker->month == 'current' AND $tracker->name == 'expressions')
                    <div class="pt-5">
                ...
                <div class="row row-cols-3 row-cols-sm-3 row-cols-md-6 row-cols-lg-12">
                    ...
                    <div class="col my-3"><h4>Jan</h4>
                        @foreach($trackers->where('year', '2022') as $tracker)
                            @if($tracker->month == 'Jan' AND $tracker->name == 'expressions')
                    ...
                    <div class="col my-3"><h4>Feb</h4>
                        @foreach($trackers->where('year', '2022') as $tracker)
                            @if($tracker->month == 'Feb' AND $tracker->name == 'expressions')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
                    ...
                    <div class="col my-3"><h4>Mar</h4>
                        @foreach($trackers->where('year', '2022') as $tracker)
                            @if($tracker->month == 'Mar' AND $tracker->name == 'expressions')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
                    ...
                    <div class="col my-3"><h4>Apr</h4>
                        @foreach($trackers->where('year', '2022') as $tracker)
                            @if($tracker->month == 'Apr' AND $tracker->name == 'expressions')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
                    ...
                    <div class="col my-3"><h4>May</h4>
                        @foreach($trackers->where('year', '2022') as $tracker)
                            @if($tracker->month == 'May' AND $tracker->name == 'expressions')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
                    ...
                    <div class="col my-3"><h4>Jun</h4>
                        @foreach($trackers->where('year', '2022') as $tracker)
                            @if($tracker->month == 'Jun' AND $tracker->name == 'expressions')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
                    ...
                    <div class="col my-3"><h4>Jul</h4>
                        @foreach($trackers->where('year', '2022') as $tracker)
                            @if($tracker->month == 'Jul' AND $tracker->name == 'expressions')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
                    ...
                    <div class="col my-3"><h4>Aug</h4>
                        @foreach($trackers->where('year', '2022') as $tracker)
                            @if($tracker->month == 'Aug' AND $tracker->name == 'expressions')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
                    ...
                    <div class="col my-3"><h4>Sep</h4>
                        @foreach($trackers->where('year', '2022') as $tracker)
                            @if($tracker->month == 'Sep' AND $tracker->name == 'expressions')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
                    ...
                    <div class="col my-3"><h4>Oct</h4>
                        @foreach($trackers->where('year', '2022') as $tracker)
                            @if($tracker->month == 'Oct' AND $tracker->name == 'expressions')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
                    ...
                    <div class="col my-3"><h4>Nov</h4>
                        @foreach($trackers->where('year', '2022') as $tracker)
                            @if($tracker->month == 'Nov' AND $tracker->name == 'expressions')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
                    ...
                    <div class="col my-3"><h4>Dec</h4>
                        @foreach($trackers->where('year', '2022') as $tracker)
                            @if($tracker->month == 'Dec' AND $tracker->name == 'expressions')
                                <span class="text-muted">{{ $tracker->minutes }}<small>min</small></span>
                                <div class="graph graph-{{$tracker->minutes}}">
                                </div>
                            @endif
