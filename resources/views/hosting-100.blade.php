...
@section('content')
    ...
    <div class="" style="min-height: 100vh; width: 100%;">
       <div class="container">
           ...
           <div class="row">
               <div class="col-sm">
                   <p class="font-a mb-0 ml-3" style="color: #43D3ED;">$100/mo</p>
               ...
               <div class="col-sm">
                   <div id="paypal-button-container-P-9FV07691CV9384509MG74GLA"></div>
                       ...
                       paypal.Buttons({
                           ...
                           createSubscription: function(data, actions) {
                               return actions.subscription.create({
                                   ...
                                   plan_id: 'P-9FV07691CV9384509MG74GLA'
                               });
                           },
                           onApprove: function(data, actions) {
                               alert(data.subscriptionID); // You can add optional success message for the subscriber here
                           }
                       }).render('#paypal-button-container-P-9FV07691CV9384509MG74GLA'); // Renders the PayPal button
                   </script>
               </div>
           </div>
