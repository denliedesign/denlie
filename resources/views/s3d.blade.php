        ...
        <div class="container">
            ...
            <div class="pb-5">
                ...
                <div class="bar rounded d-flex justify-content-start">
                    <div class="text-center rounded included-bars progress-bars hrs-50">30 min</div>
                </div>
            </div>
            <div class="pt-5">
...
{{--                    </div>--}}
            ...
            <div class="py-5">
                <div class="row row-cols-3 row-cols-sm-3 row-cols-md-6 row-cols-lg-12">
                    ...
                    <div class="col my-3"><h4>Jul</h4> 45 min</div>
                    <div class="col my-3"><h4>Aug</h4> 30 min</div>
